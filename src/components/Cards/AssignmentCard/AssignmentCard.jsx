  ...
  return (
    <div style={bg} className="rounded-[15px] overflow-hidden p-[2px]">
      <div className="bg-[#050F32] p-5 rounded-[15px] flex flex-col gap-3 text-[#01A4FE]">
        ...
        <div className="text-[#01A4FE] text-opacity-80 text-[15px] xss:text-[17px] lg:text-[22px] font-[400] flex flex-col items-start gap-0">
          <span>Chapter {assignment?.chapter}</span>
          <span>{assignment?.topic}</span>
        </div>
        <div className="flex flex-row gap-3 justify-between items-center">
          <span className="text-[#01A4FE] text-opacity-90 text-[15px] xss:text-[17px] lg:text-[22px] font-[400]">
